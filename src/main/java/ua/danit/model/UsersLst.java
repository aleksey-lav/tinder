...
public class UsersLst {
    public List<Users> get(){
        return new ArrayList<Users>(){{
            ...
            add(new Users("Vyvarka", "http://ginva.com/wp-content/uploads/2012/07/cute-and-beautiful-girls-wallpapers-057-600x375.jpg"));
            add(new Users("Guba", "https://lifearoundasia.com/wp-content/uploads/2017/03/beautiful-vietnamese-women-1.jpg"));
            add(new Users("Braga", "http://s2.favim.com/orig/34/beautiful-beauty-black-and-white-girl-model-Favim.com-273873.jpg"));
